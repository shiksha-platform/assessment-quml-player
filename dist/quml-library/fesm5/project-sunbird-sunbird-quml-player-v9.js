...
var ViewerService = /** @class */ (function () {
    ...
    function (currentIndex, index) {
        ...
        if (!isEmpty(indentifersForQuestions)) {
            ...
            var requests_1 = [];
            /** @type {?} */
            var chunkArray = chunk(indentifersForQuestions, 10);
            forEach(chunkArray, (/**
             * @param {?} value
             * @return {?}
             */
...
var MainPlayerComponent = /** @class */ (function () {
    ...
    function () {
        ...
        /** @type {?} */
        var childMimeType = map(this.playerConfig.metadata.children, 'mimeType');
    ...
    function () {
        /** @type {?} */
        var progressBar = this.isSectionsAvailable ? flattenDeep(this.mainProgressBar.map((/**
         * @param {?} item
         * @return {?}
         */
        function (item) { return item.children; }))) : this.mainProgressBar;
        /** @type {?} */
        var classObj = groupBy(progressBar, 'class');
        this.summary = {
    ...
    function (activeSectionIndex) {
        ...
        function (section, i) {
            ...
            _this.mainProgressBar[_this.mainProgressBar.length - 1] = __assign(__assign({}, last(_this.mainProgressBar)), { children: children });
    ...
    function (event) {
        if (this.parentConfig.isSectionsAvailable && event.identifier) {
            ...
            this.activeSection = cloneDeep(this.sections[sectionIndex_1]);
            this.mainProgressBar.forEach((/**
             * @param {?} item
             * @param {?} index
             * @return {?}
...
var SectionPlayerComponent = /** @class */ (function () {
    ...
    function () {
        ...
        function (res) {
            ...
            /** @type {?} */
            var unCommonQuestions = xorBy(_this.questions, res.questions, 'identifier');
            _this.questions = uniqBy(_this.questions.concat(unCommonQuestions), 'identifier');
            _this.sortQuestions();
    ...
    function () {
        ...
        /** @type {?} */
        var classObj = groupBy(this.progressBarClass, 'class');
        return {
    ...
    function () {
        ...
        function (image) {
            ...
            forEach(_this.currentQuestionsMedia, (/**
             * @param {?} val
             * @return {?}
             */
            function (val) {
